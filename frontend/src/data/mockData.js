...
export const categories = [
  {
    ...
    description: 'Tintas em várias cores e tamanhos'
  },
  {
    id: '2',
    name: 'Brinquedos',
...
export const products = [
  {
    ...
    originalPrice: 3000,
    image: 'https://images.unsplash.com/photo-1572037958571-83764a7e4f9e',
    description: 'Tintas premium de 20cm em cores variadas. Duração de 8-12 horas.',
    stock: 150,
  ...
  {
    id: '13',
    name: 'Kit Festa Neon Completo - 100 Peças',
    category: 'adereco-festas',
    price: 8500,
    originalPrice: 10000,
    image: 'https://images.pexels.com/photos/10732987/pexels-photo-10732987.jpeg',
    description: 'Kit completo com bastões, pulseiras, colares e óculos. Perfeito para festas grandes.',
    stock: 25,
    colors: ['Sortido'],
    featured: true,
    rating: 4.9
  ...
  {
    id: '14',
    name: 'Anéis Luminosos LED - Pack 12',
    category: 'pulseiras-e-colares',
    price: 1800,
    originalPrice: 2200,
    image: 'https://images.pexels.com/photos/417458/pexels-photo-417458.jpeg',
    description: 'Anéis LED ajustáveis que brilham em várias cores.',
    stock: 90,
  ...
  {
    id: '15',
    name: 'Chapéu Neon LED - Festa',
    category: 'tiaras-e-coroas',
    price: 3200,
    originalPrice: 4000,
    image: 'https://images.unsplash.com/photo-1551564774-2c247864797e',
    description: 'Chapéu iluminado com LEDs perfeito para aniversários e festas.',
    stock: 40,
    colors: ['Rosa', 'Azul', 'Verde'],
    featured: false,
    rating: 4.8
  ...
  {
    id: '16',
    name: 'Bastão Espada Laser LED 80cm',
    category: 'bastoes-luminosos',
    price: 4500,
    originalPrice: 5500,
    image: 'https://images.pexels.com/photos/9665594/pexels-photo-9665594.jpeg',
    description: 'Bastão grande tipo espada com efeitos de luz e som.',
    stock: 50,
  ...
  {
    id: '17',
    name: 'Copos LED Recarregáveis - Pack 6',
    category: 'copos-e-tacas',
    price: 6500,
    originalPrice: 8000,
    image: 'https://images.unsplash.com/photo-1551564774-2c247864797e',
    description: 'Copos LED recarregáveis via USB com 7 cores diferentes.',
    stock: 35,
    colors: ['Transparente'],
    featured: false,
    rating: 4.8
  ...
  {
    id: '18',
    name: 'Máscara Neon LED - Halloween',
    category: 'oculos-neon',
    price: 3800,
    originalPrice: 4500,
    image: 'https://images.unsplash.com/photo-1517263904808-5dc91e3e7044',
    description: 'Máscara LED perfeita para Halloween e festas temáticas.',
    stock: 30,
    colors: ['Rosa', 'Azul', 'Verde'],
    featured: false,
    rating: 4.7
  ...
  {
    id: '19',
    name: 'Spray Neon Temporário - Set 3',
    category: 'pintura-corporal',
    price: 3500,
    originalPrice: 4200,
    image: 'https://images.unsplash.com/photo-1558043279-a860bfe6d3b5',
    description: 'Spray temporário para cabelo em cores neon. Lava facilmente.',
    stock: 60,
  ...
  {
    id: '20',
    name: 'Fita LED Neon 3m - Decoração',
    category: 'decoracoes',
    price: 4800,
    originalPrice: 6000,
    image: 'https://images.unsplash.com/photo-1506775352297-a5fa9c136675',
    description: 'Fita LED flexível para decoração de ambientes. Controle remoto incluído.',
    stock: 55,
    colors: ['Rosa', 'Azul', 'Verde', 'Multicolor'],
    featured: true,
    rating: 4.9
  }
];
...
export const testimonials = [
  {
    ...
    name: 'Ana Silva',
    rating: 5,
    comment: 'Produtos de excelente qualidade! A festa do meu filho foi um sucesso total. As tintas duraram a noite toda.',
    date: '2025-06-15'
  },
  {
    id: '2',
